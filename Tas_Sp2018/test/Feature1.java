...
public class Feature1 {
    ...
    public void testGetPunches() {
        ...
        assertEquals("#DFD9BB5C CLOCKED IN: TUE 09/05/2017 08:00:00", p2.printOriginalTimestamp());
        assertEquals("#99F0C0FA CLOCKED IN: SAT 08/19/2017 06:00:00", p3.printOriginalTimestamp());
        
        assertEquals("#0FFA272B CLOCKED OUT: MON 09/25/2017 17:30:04", p4.printOriginalTimestamp());
        assertEquals("#FCE87D9F CLOCKED OUT: TUE 09/19/2017 17:34:00", p5.printOriginalTimestamp());
        assertEquals("#FCE87D9F CLOCKED OUT: MON 08/21/2017 17:30:00", p6.printOriginalTimestamp());
        
        assertEquals("#618072EA TIMED OUT: FRI 08/11/2017 00:12:35", p7.printOriginalTimestamp());
        assertEquals("#0886BF12 TIMED OUT: THU 08/03/2017 06:06:38", p8.printOriginalTimestamp());
        assertEquals("#67637925 TIMED OUT: TUE 08/08/2017 23:12:34", p9.printOriginalTimestamp());
